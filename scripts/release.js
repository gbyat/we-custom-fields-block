...
console.log(`🚀 Creating ${releaseType} release for Custom Fields Block...`);
...
try {
    ...
    console.log('   2. Create we-custom-fields-block.zip');
    ...
    console.log('   https://github.com/gbyat/we-custom-fields-block/actions');
    console.log('');
